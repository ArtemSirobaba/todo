...
const Queen = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center h-[80vh]">
      <div>
        <input
          className="p-4 m-2 rounded-xl cursor-pointer border-2 border-red-600 hover:bg-red-600 sm:text-lg hover:text-white sm:px-10 sm:p-8"
          value="Beat-1 (V key)"
          type="submit"
          onClick={(event: React.MouseEvent<HTMLElement>) => beat1()}
        />
        <input
          className="p-4 m-2 rounded-xl cursor-pointer hover:bg-blue-600 border-2 border-blue-600 sm:text-lg hover:text-white sm:px-10 sm:p-8"
          value="Beat-2 (N key)"
          type="submit"
      ...
      <input
        className="px-4 p-1 m-6 rounded-md cursor-pointer hover:bg-yellow-600 hover:text-white sm:px-10 sm:p-4 sm:text-lg"
